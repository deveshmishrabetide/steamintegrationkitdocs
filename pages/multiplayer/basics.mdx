...
As you said, Lobbies are only existing on the Steam backend but but but, you can link a game server with a given lobby and it can be a Listen Server too.
### P2P Networking
